...
class SichuanZhaobiaoSpider(scrapy.Spider):
    name = 'sichuan_zhaobiao'
    allowed_domains = ['www.ccgp-sichuan.gov.cn']
    start_urls = ['http://www.ccgp-sichuan.gov.cn/CmsNewsController.do?method=recommendBulletinList&rp=25&page={page}&moreType=provincebuyBulletinMore&channelCode=cggg']
