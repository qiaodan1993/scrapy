...
class HeilongjiangZhongBiaoSpider(scrapy.Spider):
    name = 'heilongjiang_zhongbiao'
    ...
    form_data = {'xwzsPage.zlbh': '', 'xwzsPage.GJZ':'','xwzsPage.pageNo': '1', 'xwzsPage.pageSize':'20', 'lbbh': '5', 'id': '110','xwzsPage.LBBH': '5'}
