...
script = """
         ...
         """
class DalianZhaobiaoSpider(scrapy.Spider):
    name = 'dalian_zhaobiao'
    allowed_domains = ['www.ccgp-dalian.gov.cn']
    start_urls = ['http://www.ccgp-dalian.gov.cn/dlweb/showinfo/bxmoreinfo.aspx?CategoryNum=003001001']
