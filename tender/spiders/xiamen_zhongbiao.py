...
class XiamenZhongbiaoSpider(scrapy.Spider):
    name = 'xiamen_zhongbiao'
    ...
    def start_requests(self):
        ...
        for pageNum in range(next_page, max_page):
            yield scrapy.Request(self.start_urls[0]+ '?page='+str(pageNum)+'&notice_type=b716da75fe8d4e4387f5a8c72ac2a937', self.parse, dont_filter=True)
