...
class XizangZhongbiaoSpider(scrapy.Spider):
    name = 'xizang_zhongbiao'
    allowed_domains = ['www.ccgp-xizang.gov.cn']
    start_urls = ['http://www.ccgp-xizang.gov.cn/shopHome/morePolicyNews.action?categoryId=124,125']
